...
let i = 0;
let game = false;
let audioEnter = new Audio("/RPG_FRONT_HETIC/assets/Sounds/boutton_enter.wav");
let audioHover = new Audio("/RPG_FRONT_HETIC/assets/Sounds/boutton_hover.wav");
...
body.addEventListener("keydown", function (e) {
  ...
  if (key == 40 && i < 2) {
    ...
    playAudioEnter();
    if (i == 0) {
      window.location.href = "/RPG_FRONT_HETIC/intro/intro.html";
      game = true;
    }
    if (i == 2) {
      window.close();
